...
class TimeBlocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create time_block" do
    assert_difference('TimeBlock.count') do
      post time_blocks_url, params: { time_block: { end_time: @time_block.end_time, start_time: @time_block.start_time } }
    end
  ...
  test "should update time_block" do
    patch time_block_url(@time_block), params: { time_block: { end_time: @time_block.end_time, start_time: @time_block.start_time } }
